...
// TODO: the questions are not accurate and need to be updated, but this is a good start for now.
// we need to retrieve them from the db to avoid cheating and to make it easier to update them.
